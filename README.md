...
[![Build Status](https://travis-ci.org/rjpalermo1/core.svg?branch=master)](https://travis-ci.org/rjpalermo1/core)
...
6. If you did everything correct, https://rjpalermo1.github.io/core/ will lead to your new docs
...
- Documentation(ReDoc): https://rjpalermo1.github.io/core/
- SwaggerUI: https://rjpalermo1.github.io/core/swagger-ui/
- Look full spec:
    + JSON https://rjpalermo1.github.io/core/swagger.json
    + YAML https://rjpalermo1.github.io/core/swagger.yaml
- Preview spec version for branch `[branch]`: https://rjpalermo1.github.io/core/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://rjpalermo1.github.io/core/ with url from the message: `Server started <url>`
